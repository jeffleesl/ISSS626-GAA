...
rdacc_bmr <- rdacc %>% filter(province_en %in% c("Bangkok", "Nonthaburi", "Nakhon Pathom", 
...
Visualize how accidents vary across month using time-based color coding or heatmaps.
...
Visualizing geographic distribution of car accident by month
...
7.1 Computing STKDE by Month

7.1.1 Extracting road accident by Month
...
8.  Behavioral factors and Environmental factors
