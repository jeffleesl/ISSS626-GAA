...
### 7.2.2 Equal interval classification Y2019 and Equal quantile classification Y2019
...
```{r}
equal_2019 <- tm_shape(tourism_sf_2019) +
  tm_fill("revenue_all",
          n = 5,
          style = "equal") +
  tm_borders(alpha = 0.5) +
  tm_facets("Month_year") +
  tm_layout(main.title = "Equal interval classification Y2019",
            legend.width = 1.2)

quantile_2019 <- tm_shape(tourism_sf_2019) +
  tm_fill("revenue_all",
          n = 5,
          style = "quantile") +
  tm_borders(alpha = 0.5) +
  tm_facets("Month_year") +
  tm_layout(main.title = "Equal quantile classification Y2019",
            legend.width = 1.2)

tmap_arrange(equal_2019, 
             quantile_2019, 
             asp=1, 
             ncol=2)
```
