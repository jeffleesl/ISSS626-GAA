...
The [glue](https://cran.r-project.org/web/packages/glue/index.html) and [broom.helpers](https://cran.r-project.org/web/packages/broom.helpers/index.html) packages have been installed to ensure gtsummary can run.
